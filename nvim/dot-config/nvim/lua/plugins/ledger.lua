return {
	...
	init = function()
		...
		vim.keymap.set('n', '<leader>la', function() vim.cmd('LedgerAlign') end)
		vim.keymap.set('n', '<leader>lab', function() vim.cmd('LedgerAlignBuffer') end)
		vim.keymap.set('n', '<leader>ld', function() vim.fn['ledger#transaction_date_set']('line(".")', 'primary') end)
		vim.keymap.set('n', '<leader>ldu', function() vim.fn['ledger#transaction_date_set']('line(".")', 'unshift') end)
		vim.keymap.set('n', '<leader>ls', function() vim.fn['ledger#transaction_state_toggle']('line(".")', '!*') end)
	end,
	opt = {},
}
